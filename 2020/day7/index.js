...
clear gray bags contain 4 muted gray bags, 2 wavy turquoise bags, 3 dotted plum bags.`.split(/\n/);
...
console.log('part 1:', goldCount);
console.log('part 2:', countChildren('shiny gold', 0));
